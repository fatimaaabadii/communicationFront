...
import { api, getDelegations, getUsers, getCurrentUser,getArticles } from "/src/api";
  ...
  
{
  ...
  cell: ({ row }) => {
    ...
    return <div className={`rtl:text-left ${couleur} p-2 rounded-md w-full h-full`}>{etat}</div>;
  },
}
